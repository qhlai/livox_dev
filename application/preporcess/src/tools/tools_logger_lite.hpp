...
// namespace logger{
    enum loglevel_e
        {logFATAL,logERROR, logWARN, logINFO, logDEBUG, logDEBUG1, logDEBUG2, logDEBUG3, logDEBUG4};
    ...
    void log_test(){
        ...
        logit(logINFO) << "foo " << "bar " << "baz";

        logit(logERROR) << "logERROR";
        logit(logWARN) << "logWARNING";
        logit(logINFO) << "logINFO";
        logit(logDEBUG) << "logDEBUG";
        logit(logDEBUG1) << "logDEBUG1";
        logit(logDEBUG2) << "logDEBUG2";
        logit(logDEBUG3) << "logDEBUG3";
